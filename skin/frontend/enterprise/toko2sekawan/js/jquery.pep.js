...
;(function ( $, window, undefined ) {
  ...
  Pep.prototype.handleMove = function() {
      ...
      //Temporarily locked drag action
      return;
...
//      console.log(curY);
//      if(this.ev.y >= (document.body.scrollTop + $(window).height()) ){
//          dy = 0;
//      }
//      if(this.ev.y <= document.body.scrollTop){
//          dy = 0;
//      }
//      console.log(this.ev.y - (document.body.scrollTop + $(window).height()));
...
//console.log(this.active);
            ...
            if (!this.active)
              return;
//      console.log(isMoved);
//      if(this.$el.stop(true,true)) console.log('ok');
      if(isMoved == 0 ){
          $(this.options.displayDivName).fadeToggle();
      }
      else{
          var winWidth = $(window).width();
          var left = this.$el.offset().left;
          var line = (winWidth-60)/2;

          if(left > line){
              this.$el.animate({  left: winWidth-65 }, this.options.cssEaseDuration/2, 'easeOutQuad', {queue: false});
          }
          else{
              this.$el.animate({  left: 5 }, this.options.cssEaseDuration/2, 'easeOutQuad', {queue: false});
          }
      }
      isMoved=0;

//      console.log(left);
//      if(left > 2 && left < (winWidth - 62)){
//          console.log('asd');
//      }

//      this.$el.animate({ top: '-=20', left: '-=20' }, this.options.cssEaseDuration/2, 'easeOutQuad', {queue: false});
            // log it
            this.log({ type: 'event', event: ev.type });
...
//            }, this.options.cssEaseDuration );
  ...
  Pep.prototype.moveTo = function(x,y, animate) {
      ...
      isMoved=x.replace('+',"").replace('-',"").replace('=',"")+','+y.replace('+',"").replace('-',"").replace('=',"");
//console.log(isMoved);
...
//          upperYLimit = (document.body.scrollTop + $(window).height());
//          lowerYLimit = document.body.scrollTop;
...
//      upperYLimit       = this.$container.height() - this.$el.outerHeight();
      upperYLimit       = document.body.scrollTop + $(window).height() - 60;
//console.log(lowerYLimit+'   '+upperYLimit );
      // is our object trying to move outside lower X & Y limits?
    ...
    if ( this.pos.y + dy > upperYLimit )    hash.y = upperYLimit - document.body.scrollTop;
