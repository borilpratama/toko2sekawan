...
//			$contentDivs = $container.children("div").addClass('ui-slider-tab-content').remove();
			$contentDivs = $container.children("div").children("div").addClass('ui-slider-tab-content');
			// Tabs
			$tabsList = $container.children("ul.tabs_control").addClass('ui-slider-tabs-list').remove();
			...
			// Content container
			$contentDivsContainer = $(".ui-slider-tabs-content-container");

			// Position the tabs on top or bottom
			if(settings.position == 'bottom')
				$container.append($tabsListWrapper.addClass('bottom'));
			else
				$container.prepend($tabsListWrapper);
