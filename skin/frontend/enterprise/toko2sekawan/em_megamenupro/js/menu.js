...
function mobile() {
	...
	$('.em_nav').each(function(i) {
		...
		$('.em-catalog-navigation li.parent .level-top, .menu-item-link.menu-item-parent', $nav).each(function() {
//			$(this).prepend('<a href="javaScript:void(0);" class="arrow"><span>&gt;</span></a>');
            $(this).prepend('<span class="toko2sekawan-icon-arrow">&nbsp;</span>');
		});
...
function fixMegaMenuOverflow() {
	...
	$('.em_nav > .hnav > .menu-item-link > .menu-container').parent().mouseover(function(){
    ...
    $('.em_nav > .hnav > .menu-item-link > .menu-container').parent().mouseout(function(){
        var $container = $(this).children('.menu-container');
        var isIE8 = $.browser.msie && +$.browser.version === 8;        
        if ( isIE8 ) {
...
$(document).ready(function() {
    ...
    $('#menuleft').each(function(){
        if($(this).offset().left < $('.em_col_main').first().offset().left){ // this is left menu
            $(this).parent().addClass('menu-left');
        } else {
            $(this).parent().addClass('menu-right');
        }
    });
	mobile();
});
